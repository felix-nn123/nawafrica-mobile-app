...
data={`${totalCount===0?"No":totalCount} Available Houses In ${selectedAfricaCountry?`${selectedCity&&selectedCountryInputs(selectedCity) + ", "}${selectedCountryInputs(selectedAfricaCountry)}`:userLocation.city&&selectedAfricaCountry?`${userLocation.city}, ${userLocation.country}`:"Nawafrica Marketplace"} For Sale`}
/>}
