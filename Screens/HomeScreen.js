...
import { StyleSheet, ScrollView, RefreshControl, View, ImageBackground, Button, Alert } from 'react-native';
...
//function that causes the scrollView to scroll to top as we clich home bottom taps
...
//hide or show the search input fields
const onPressShow=()=>{
...
//function that takes you to listing details
...
<Button onPress={onPressShow} style={showSearchContainer?styles.searchingButtonContainer1:styles.searchingButtonContainer} title={`${showSearchContainer?"Close":"Open"} Search Device`}/>
<View style={{height,padding:10}}>
{showSearchContainer&&<ImageBackground  resizeMethod="resize" source={items[0]?{uri:items[0].main_photo.path.url}:require('../assets/lion.jpg')}  style={styles.welcomeOuterContainer}>
<AppPickerNoObj
